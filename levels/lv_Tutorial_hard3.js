...
export const lv_Tutorial_hard3 = {
	...
	"camera_triggers": [
		0, 5, -4, 8, 18, 30, 4, 4, 140, 0.1, 5.0, 0.0, 18.0,
		44, 48, -4, 8, 65, 180, 2, 15, 175, 0.05, 1.2, 48.0, 45.0,
		52, 55, -24, 8, 65, 180, 2, 15, 175, 0.175, 5.0, 130.0, 45.0,
		62, 80, -24, 8, 65, 180, -4, 15, 175, 0.175, 5.0, 130.0, 45.0,
		96, 130, -24, 8, 65, 180, -10, 15, 175, 0.175, 5.0, 130.0, 45.0,
		160, 180, -24, 8, 170, 180, -10, -10, 140, 0.05, 1.5, 0.0, 32.0,
	],
	"bgm_name": "Tutorial",
	"background": BG,
};
